        ...
        <b-table-simple small
            ...
            <b-thead class="text-center">
                ...
                <b-tr>
                    ...
                    <b-th colspan="4">з них розглянуто</b-th>
            ...
            <b-tbody class="text-center">
                <b-tr>
                    ...
                    <b-td :class="{ 'bg-info text-white': appType === 'alienation_under_consideration_phys' }">
                        <a href="#" @click.prevent="$emit('show-apps', 'alienation_under_consideration_phys')">{{ statistics.alienation_under_consideration_phys }}</a>
                    </b-td>
                </b-tr>
                <b-tr>
                    ...
                    <b-td :class="{ 'bg-info text-white': appType === 'alienation_under_consideration_jur' }">
                        <a href="#" @click.prevent="$emit('show-apps', 'alienation_under_consideration_jur')">{{ statistics.alienation_under_consideration_jur }}</a>
                    </b-td>
                </b-tr>
                <b-tr>
                    ...
                    <b-td :class="{ 'bg-info text-white': appType === 'using_under_consideration_phys' }">
                        <a href="#" @click.prevent="$emit('show-apps', 'using_under_consideration_phys')">{{ statistics.using_under_consideration_phys }}</a>
                    </b-td>
                </b-tr>
                <b-tr>
                    <b-td>Юридичні особи</b-td>
                    ...
                    <b-td :class="{ 'bg-info text-white': appType === 'using_under_consideration_jur' }">
                        <a href="#" @click.prevent="$emit('show-apps', 'using_under_consideration_jur')">{{ statistics.using_under_consideration_jur }}</a>
                    </b-td>
                </b-tr>
                <b-tr>
                    <b-td></b-td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                statistics: {
                    ...
                    alienation_under_consideration_phys: 0,
                    alienation_under_consideration_jur: 0,
                    using_under_consideration_phys: 0,
                    using_under_consideration_jur: 0,
                },
            }
        },
        computed: {
            ...
            under_consideration_sum() {
                return this.statistics.alienation_under_consideration_phys
                    + this.statistics.alienation_under_consideration_jur
                    + this.statistics.using_under_consideration_phys
                    + this.statistics.using_under_consideration_jur;
            }
        },
        ...
        methods: {
            getStatisticsData: function () {
                this.isBusy = true;
                axios.get('/api/statistics/dg_under_consideration/', {
                    params: {
