<template>
    <b-table-simple small caption-top responsive striped bordered id="statistics-table">
        <caption>Реєстр адмінпослуг: "за видачу дубліката свідоцтва", період: від {{ dateFrom | moment("DD.MM.YYYY") }} до {{ dateTo | moment("DD.MM.YYYY") }}</caption>
        <b-thead class="text-center">
            <b-tr>
                ...
                <b-th rowspan="2">Кількість виданих дублікатів свідоцтв (на одну заявку)</b-th>
        ...
        <b-tbody class="text-center">
            <b-tr v-for="item in statistics">
                ...
                <b-td>{{ item.inn }}</b-td>
                <b-td>{{ item.dublicates_count }}</b-td>
                <b-td>{{ item.date }}</b-td>
